...
Provide pure, session-aligned EMA, True Range, Wilder ATR, and Wilder RSI calculations so later analysis can derive Features from completed-session market facts without I/O, lookahead, or invented warm-up values.
